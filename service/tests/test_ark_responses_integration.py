"""火山方舟 ark_responses 端到端集成测试（需网络与 .env 中 LLM_API_KEY）。"""
...
pytestmark = pytest.mark.skipif(not _ark_configured(), reason="LLM_API_KEY / ARK_MODEL 未配置")
