...
from deskbot_server.web.blueprints.chat_bp import bp as chat_bp
...
from deskbot_server.web.blueprints.quest_bp import bp as quest_bp
from deskbot_server.web.blueprints.site import bp as site_bp
from deskbot_server.web.blueprints.voice_clone_bp import bp as voice_clone_bp
...
def create_app() -> Flask:
    from deskbot_server.web.blueprints.app_bp import invalidate_upstream_snapshot_cache
    invalidate_upstream_snapshot_cache()
    load_dotenv()
