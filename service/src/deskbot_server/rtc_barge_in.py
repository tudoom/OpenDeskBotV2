...
# 2026-09-10 用户定「温和」打断：不管中英文，都得连续说满 1.0 s 才算真的要打断
# （原来中文 0.60 s / 英文 0.90 s，办公室里旁人一句话就把小歪的回答压住十几秒）。
_MIN_ORDINARY_BARGE_IN_SECONDS = 1.0
...
# lone filler ("嗯", "啊") stays below the gate.
_MIN_CJK_BARGE_IN_CHARS = 3
_MIN_CJK_BARGE_IN_SECONDS = 1.0
