...
SERVO_CFG_FILE = str(GLOBAL_DATA_DIR / "servo.json")
...
MEMORIES_FILE = str(DATA_DIR / "memories.json")
DEVICE_VOLUME_FILE = str(GLOBAL_DATA_DIR / "device_volume.json")
EMOTION_EXPR_MAP_FILE = str(DATA_DIR / "emotion_expr_map.json")
SCENE_PLAYBOOKS_FILE = str(GLOBAL_DATA_DIR / "scene_playbooks.json")
